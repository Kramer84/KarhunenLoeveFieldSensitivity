...
Comme l'utilisation des codes dans openTURNS est fortement imbriquée (L'on ne peut faire l'analyse de Sobol' lorsque les données arrivent comme cela est prévu par openTURNS), il nous faut générer les Samples différement et revoir la manière dont on génère nos samples et  comment on récupère les indices de Sobol'. 
