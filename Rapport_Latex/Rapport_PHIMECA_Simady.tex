...
Une fois cette étape finie, on à accès aux indices de sobol pour chaque élément du champ. \\
...
Un des exemples étudiés par eux est celui d'une poutre en flexion dont le chargement (appliqué en son centre) est déterminé par un champ stochastique dans le temps. La grande différence entre ce modèle et le notre est que chez eux c'est soit la contrainte maximale qui est étudiée, alors que nous étudions le champ des contraintes de von mises. 
